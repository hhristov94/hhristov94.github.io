...
A natural question follows. If we take this span as something on its own can we regard it as another vector space? Intiutively, it makes sense but let's actually use the eight axioms mentioned earlier. If they apply to the definition of span then we have ourselves a vector space - easy:
...
a_1(c_1v_1 + c_2v_2+ ... + c_nv_n) +\\
a_2(c_1v_1 + c_2v_2+ ... + c_nv_n) + ...\\
